...
import com.falcon.unikit.adapters.OnBoardingItemAdapter
import com.falcon.unikit.databinding.FragmentWalkThroughBinding
import com.falcon.unikit.model.OnBoardingItem
...
class WalkThroughFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (tokenManager.getToken() != null) {
            findNavController().navigate(R.id.action_walkThroughFragment_to_resources)
        }
        return binding.root
